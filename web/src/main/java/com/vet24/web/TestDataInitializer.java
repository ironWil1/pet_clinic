...
public class TestDataInitializer implements ApplicationRunner {
    ...
    public TestDataInitializer(PetService petService, RoleService roleService, UserService userService, ClientService clientService,
                               ...
                               ReproductionService reproductionService,DoctorService doctorService,
    ...
    public void userInitialize() {
       ...
       doctorService.persist(new Doctor("John", "Smith", "doctorLogin@gmail.com",
                "123456",  new Role(RoleNameEnum.DOCTOR)));
    }
