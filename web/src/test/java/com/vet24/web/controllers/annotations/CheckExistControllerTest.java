...
public class CheckExistControllerTest extends ControllerAbstractIntegrationTest {
    ...
    public void testCheckEntityExistOneParameter() throws Exception {
    ...
    @DataSet(cleanBefore = true, value = {
            ...
            "/datasets/controllers/checkExistControllerTest/pet-entities.yml",
            "/datasets/controllers/checkExistControllerTest/clinical-examination.yml"})
    public void testCheckEntityNotExistOneParameter() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(URI + "/exam")
                        .param("petId", "77")
                        .header("Authorization", "Bearer " + token))
    ...
    @DataSet(cleanBefore = true, value = {
            ...
            "/datasets/controllers/checkExistControllerTest/pet-entities.yml",
            "/datasets/controllers/checkExistControllerTest/clinical-examination.yml"})
    public void testCheckEntityExistTwoParameters() throws Exception {
    ...
    @DataSet(cleanBefore = true, value = {
            ...
            "/datasets/controllers/checkExistControllerTest/pet-entities.yml",
            "/datasets/controllers/checkExistControllerTest/clinical-examination.yml"})
    public void testCheckEntityNotExistTwoParameters() throws Exception {
    ...
    @DataSet(cleanBefore = true, value = {
            ...
            "/datasets/controllers/checkExistControllerTest/pet-entities.yml",
            "/datasets/controllers/checkExistControllerTest/clinical-examination.yml"})
    public void testCheckEntityExistTwoIdParameters() throws Exception {
    ...
    @DataSet(cleanBefore = true, value = {
            ...
            "/datasets/controllers/checkExistControllerTest/pet-entities.yml",
            "/datasets/controllers/checkExistControllerTest/clinical-examination.yml"})
    public void testCheckEntityNotExistTwoIdParameters() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(URI + "/103/exam")
                        .param("petId", "88")
                        .header("Authorization", "Bearer " + token))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
