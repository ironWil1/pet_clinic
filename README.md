...
Для смены профиля при запуске сервера:

1. В главном меню сверху открываем "Run".
2. В выпадающем меню выбираем пункт "Edit Configurations..."
3. В поле "Active profiles" пишем имя профиля "test".